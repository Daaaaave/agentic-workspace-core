...
| Agent | Reusable way agents should work. | Store in `.agents/skills/` or `AGENTS.md`; tool proxies such as `CLAUDE.md` should import, not duplicate, shared instructions. |
