...
# Agentic Workspace Core Knowledge

This is the human-readable home for durable knowledge about Agentic Workspace Core.

## Start Here

- Use `llms.txt` for a compact generated map.
- Use `docs/generated/knowledge-map.md` for generated navigation.
- Use `.agents/knowledge-core/README.md` for the portable core contract.
