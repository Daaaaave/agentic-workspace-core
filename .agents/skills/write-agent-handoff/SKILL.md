...
- Authority And Verification: what must be verified before acting and what the handoff cannot override.
...
- Checks: commands run and results, including failures and skipped checks.
...
- Suggested Skills: skills the next agent should load, if useful.
